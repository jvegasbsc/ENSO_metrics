...
def compute_collection(
    ...
    dict_col_meta = {
        "name": dict_mc["long_name"],
        "description_of_the_collection": dict_mc["description"],
        "metrics": {},
    }
    dict_col_valu = dict()
    ...
    for metric in list_metrics:
        ...
        try:
            modelFile1 = dictDatasets["model"][modelName][list_variables[0]][
                "path + filename"
            ]
        except:
            modelFile1 = ""
        try:
            modelVarName1 = dictDatasets["model"][modelName][
                list_variables[0]
            ]["varname"]
        except:
            modelVarName1 = ""
        try:
            modelFileArea1 = dictDatasets["model"][modelName][
                list_variables[0]
            ]["path + filename_area"]
        except:
            modelFileArea1, modelAreaName1 = None, None
        else:
            modelAreaName1 = dictDatasets["model"][modelName][
                list_variables[0]
            ]["areaname"]
        try:
            modelFileLandmask1 = dictDatasets["model"][modelName][
                list_variables[0]
            ]["path + filename_landmask"]
        except:
            modelFileLandmask1, modelLandmaskName1 = None, None
        else:
            modelLandmaskName1 = dictDatasets["model"][modelName][
                list_variables[0]
            ]["landmaskname"]
        ...
        arg_var2 = {
            "modelFileArea1": modelFileArea1,
            "modelAreaName1": modelAreaName1,
            "modelFileLandmask1": modelFileLandmask1,
            "modelLandmaskName1": modelLandmaskName1,
        ...
        if len(list_variables) > 1:
            try:
                arg_var2["modelFile2"] = dictDatasets["model"][modelName][
                    list_variables[1]
                ]["path + filename"]
            except:
                arg_var2["modelFile2"] = ""
            try:
                arg_var2["modelVarName2"] = dictDatasets["model"][modelName][
                    list_variables[1]
                ]["varname"]
            except:
            ...
            try:
                arg_var2["modelFileArea2"] = dictDatasets["model"][modelName][
                    list_variables[1]
                ]["path + filename_area"]
            except:
                arg_var2["modelFileArea2"], arg_var2["modelAreaName2"] = (
                    None,
                    None,
                )
            else:
                arg_var2["modelAreaName2"] = dictDatasets["model"][modelName][
                    list_variables[1]
                ]["areaname"]
            try:
                arg_var2["modelFileLandmask2"] = dictDatasets["model"][
                    modelName
                ][list_variables[1]]["path + filename_landmask"]
            except:
                (
                    arg_var2["modelFileLandmask2"],
                    arg_var2["modelLandmaskName2"],
                ) = (None, None)
            else:
                arg_var2["modelLandmaskName2"] = dictDatasets["model"][
                    modelName
                ][list_variables[1]]["landmaskname"]
        ...
        if (
            ...
            or (
                ...
                and (
                    arg_var2["modelFile2"] is None
                    or len(arg_var2["modelFile2"]) == 0
                    or (
                        isinstance(arg_var2["modelFile2"], list)
                        and None in arg_var2["modelFile2"]
                    )
                )
            )
        ):
            ...
            if (
                len(list_variables) > 1 and arg_var2["modelFile2"] is None
            ) or (
            ...
            if (
                ...
                for ff, vv in zip(
                    arg_var2["modelFile2"], arg_var2["modelVarName2"]
                ):
                    if ff is None or vv is None:
                        print(
                            "\033[94m"
            ...
            or (
                len(list_variables) > 1
                and (
                    arg_var2["obsFile2"] is None
                    or len(arg_var2["obsFile2"]) == 0
                    or (
                        isinstance(arg_var2["obsFile2"], list)
                        and None in arg_var2["obsFile2"]
                    )
                )
            )
        ):
            ...
            if (
                ...
                for ff, vv in zip(
                    arg_var2["obsFile2"], arg_var2["obsVarName2"]
                ):
                    if ff is None or vv is None:
                        print(
                            "\033[94m"
            ...
            valu, vame = compute_metric(
                ...
                obsFile1,
                obsVarName1,
                dict_regions[list_variables[0]],
                user_regridding=user_regridding,
                debug=debug,
                netcdf=netcdf,
            ...
            keys2 = list(
                set(
                    [
                        ...
                        .replace("__", "")
                        .replace("_error", "")
                        for ll in list(valu[keys1[0]].keys())
                        for kk in list(valu[keys1[0]][ll].keys())
                    ]
                )
            )
            if len(keys2) > 1:
                for kk in keys2:
                    ...
                    for ll in keys3:
                        mm[ll] = {
                            "value": valu["metric"][ll][kk + "__value"],
                            "value_error": valu["metric"][ll][
                                kk + "__value_error"
                            ],
                        }
                    ...
                    for ll in keys3:
                        dd[ll] = {
                            "value": valu["diagnostic"][ll][kk + "__value"],
                            "value_error": valu["diagnostic"][ll][
                                kk + "__value_error"
                            ],
                        }
                    dict_col_valu[metric + kk] = {
                        "metric": mm,
                        "diagnostic": dd,
                    }
                    mm = dict(
                        (ii, vame["metric"][ii])
                        for ii in list(vame["metric"].keys())
                        if "units" not in ii
                    )
                    mm["units"] = vame["metric"][kk + "__units"]
                    dict_col_meta["metrics"][metric + kk] = {
                        "metric": mm,
                        "diagnostic": vame["diagnostic"],
                    }
                    del mm, dd
            else:
                dict_col_valu[metric], dict_col_meta["metrics"][metric] = (
                    valu,
                    vame,
                )
...
#
def math_metric_computation(
    model, model_err, obs=None, obs_err=None, keyword="difference"
):
    """
    ...
    if keyword not in [
        ...
        metric, metric_err, description_metric = (
            None,
            None,
            "unknown keyword for the mathematical computation of the metric: "
            + str(keyword),
        )
        list_strings = [
            "ERROR"
        ...
        if model is not None and obs is not None:
            if keyword == "difference":
                ...
                description_metric = (
                    "The metric is the relative difference between model and observations values "
                    + "(M = [model-obs] / obs)"
                )
                metric = (model - obs) / float(obs)
            else:
                description_metric = (
                    "The metric is the absolute values of the relative difference between model and"
                    + " observations values (M = 100 * abs[[model-obs] / obs])"
                )
                metric = 100.0 * abs((model - obs) / float(obs))
        else:
        ...
        if model_err is not None or obs_err is not None:
            if keyword == "difference":
                ...
                if model is not None and obs is not None:
                    metric_err = float(
                        (obs * (model_err + obs_err) + (model - obs) * obs_err)
                        / NUMPYsquare(obs)
                    )
                    if keyword == "abs_relative_difference":
                        metric_err = metric_err * 100.0
                else:
                    metric_err = None
        else:
            metric_err = None
...
def compute_metric(
    ...
    if noerror is False:
        if isinstance(modelFile1, list):
            tmp = str(
                [
                    modelVarName1[kk]
                    for kk, file1 in enumerate(modelFile1)
                    if isinstance(file1, str) is False
                ]
            )
        else:
            tmp = str(modelVarName1)
        tmperr = "model var1 (" + tmp + ") not given"
    if metric in list(dict_twoVar.keys()) + list(
        dict_twoVar_modelAndObs.keys()
    ):
        if isinstance(modelFile2, list):
            noerror2 = all(
                isinstance(file1, str) is True for file1 in modelFile2
            )
        else:
        ...
        if noerror2 is False:
            if isinstance(modelFile2, list):
                tmp = str(
                    [
                        modelVarName2[kk]
                        for kk, file1 in enumerate(modelFile2)
                        if isinstance(file1, str) is False
                    ]
                )
            else:
    ...
    if noerror is False:
        ...
        if metric in list(dict_oneVar_modelAndObs.keys()) or metric in list(
            dict_twoVar_modelAndObs.keys()
        ):
            #
            ...
            for ii in range(len(obsNameVar1)):
                ...
                if metric in list(dict_oneVar_modelAndObs.keys()):
                    ...
                    if metric == "EnsoSstMap" and output_name in sst_only:
                        ...
                        diagnostic1[output_name] = dict_oneVar_modelAndObs[
                            metric
                        ](
                            modelFile1,
                            modelVarName1,
                    ...
                    for jj in range(len(obsNameVar2)):
                        ...
                        diagnostic1[output_name] = dict_twoVar_modelAndObs[
                            metric
                        ](
                            modelFile1,
                            modelVarName1,
            ...
            for obs in list(diagnostic1.keys()):
                ...
                if "value" in list(diagnostic1[obs].keys()):
                    dict_metric_val[obs] = {
                        "value": diagnostic1[obs]["value"],
                        "value_error": diagnostic1[obs]["value_error"],
                    }
                    dict_diagnostic[modelName] = {
                        "value": None,
                        "value_error": None,
                    }
                    ...
                    lkeys = list(
                        set(
                            [
                                key.split("__")[0]
                                for key in list(diagnostic1[obs].keys())
                                if "value" in key
                            ]
                        )
                    )
                    for key in lkeys:
                        try:
                            ...
                            dict_metric_val[obs] = {
                                key
                                + "__value": diagnostic1[obs][key + "__value"],
                                key
                                + "__value_error": diagnostic1[obs][
                                    key + "__value_error"
                                ],
                            }
                            dict_diagnostic[modelName] = {
                                key + "__value": None,
                                key + "__value_error": None,
                            }
                            dict_diagnostic[obs] = {
                                key + "__value": None,
                                key + "__value_error": None,
                            ...
                            dict_metric_val[obs][
                                key + "__value"
                            ] = diagnostic1[obs][key + "__value"]
                            dict_metric_val[obs][
                                key + "__value_error"
                            ] = diagnostic1[obs][key + "__value_error"]
                ...
                dict_diagnostic_metadata[modelName] = {
                    "name": modelName,
                    "nyears": diagnostic1[obs]["nyears_model"],
                    "time_period": diagnostic1[obs]["time_period_model"],
                }
                dict_diagnostic_metadata[obs] = {
                    "name": obs,
                    "nyears": diagnostic1[obs]["nyears_observations"],
                    "time_period": diagnostic1[obs][
                ...
                if "events_model" in list(diagnostic1[obs].keys()):
                    dict_diagnostic_metadata[modelName][
                        "events"
                    ] = diagnostic1[obs]["events_model"]
                    dict_diagnostic_metadata[obs]["events"] = diagnostic1[obs][
                        "events_observations"
                    ]
                if "keyerror" in list(diagnostic1[obs].keys()):
                    dict_diagnostic_metadata[modelName][
                        "keyerror"
                    ] = diagnostic1[obs]["keyerror"]
            ...
            if metric in list(dict_oneVar.keys()):
                ...
                print(
                    "\033[94m"
                    + str().ljust(5)
                    + "ComputeMetric: twoVarmetric = "
                    + str(modelName)
                    + "\033[0m"
                )
                keyarg["project_interpreter_var2"] = keyarg[
                    "project_interpreter"
                ]
            ...
            dict_diagnostic[modelName] = {
                "value": diagnostic1["value"],
                "value_error": diagnostic1["value_error"],
            }
            if "nonlinearity" in list(diagnostic1.keys()):
                dict_diagnostic[modelName]["nonlinearity"] = diagnostic1[
                    "nonlinearity"
                ]
                dict_diagnostic[modelName]["nonlinearity_error"] = diagnostic1[
                    "nonlinearity_error"
                ]
            # puts diagnostic metadata in its proper dictionary
            dict_diagnostic_metadata[modelName] = {
                ...
                "time_period": diagnostic1["time_period"],
            }
            if "events_model" in list(diagnostic1.keys()):
                dict_diagnostic_metadata[modelName]["events"] = diagnostic1[
                    "events"
                ]
            if "keyerror" in list(diagnostic1.keys()):
                dict_diagnostic_metadata[modelName]["keyerror"] = diagnostic1[
                    "keyerror"
                ]
            #
            # observations diag
            ...
            for obs in list(diag_obs.keys()):
                ...
                (
                    ...
                    metric_err,
                    description_metric,
                ) = math_metric_computation(
                    diagnostic1["value"],
                    diagnostic1["value_error"],
                    obs=diag_obs[obs]["value"],
                    obs_err=diag_obs[obs]["value_error"],
                    keyword=keyarg["metric_computation"],
                )
                dict_metric_val[obs] = {
                    "value": metric_val,
                    "value_error": metric_err,
                }
                # puts metric / diagnostic values in its proper dictionary
                dict_diagnostic[obs] = {
                    "value": diag_obs[obs]["value"],
                    "value_error": diag_obs[obs]["value_error"],
                }
                if "nonlinearity" in list(diag_obs[obs].keys()):
                    dict_diagnostic[obs]["nonlinearity"] = diag_obs[obs][
                        "nonlinearity"
                    ]
                    dict_diagnostic[obs]["nonlinearity_error"] = diag_obs[obs][
                        "nonlinearity_error"
                    ]
                # puts diagnostic metadata in its proper dictionary
                dict_diagnostic_metadata[obs] = {
                    ...
                    "time_period": diag_obs[obs]["time_period"],
                }
                if "events_model" in list(diag_obs[obs].keys()):
                    dict_diagnostic_metadata[obs]["events"] = diag_obs[obs][
                        "events"
                    ]
                if "keyerror" in list(diag_obs[obs].keys()):
                    dict_diagnostic_metadata[obs]["keyerror"] = diag_obs[obs][
                        "keyerror"
                    ]
            if keyarg["metric_computation"] in [
                "ratio",
                "relative_difference",
            ]:
        ...
        for key in list_keys:
            if key == "method":
                ...
                try:
                    ...
                    dict_diagnostic_metadata[
                        "method_nonlinearity"
                    ] = diagnostic1["method_nonlinearity"]
            else:
                dict_diagnostic_metadata[key] = diagnostic1[key]
        # creates the output dictionaries
        dict_metrics = {
            "metric": dict_metric_val,
        ...
        if len(obsNameVar2) > 0:
            for ii in range(len(obsNameVar2)):
                if isinstance(obsVarName2[ii], list):
                    ...
                    datasets = (
                        datasets + obsNameVar2[ii] + "'s " + obsVarName2[ii]
                    )
